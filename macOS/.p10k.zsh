# Generated by Powerlevel10k configuration wizard on 2023-03-23 at 22:06 HKT.
...
() {
  ...
  function prompt_my_pnpm_version() {
    if (( ${+commands[pnpm]} )); then
      ...
      p10k segment -i "$POWERLEVEL9K_MY_PNPM_VERSION_ICON" -t "${pnpm_version}"
    fi
  }
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=233
  ...
  ################################[ my_pnpm_version: show pnpm version ]#################################
  typeset -g POWERLEVEL9K_MY_PNPM_VERSION_FOREGROUND=0
  typeset -g POWERLEVEL9K_MY_PNPM_VERSION_BACKGROUND=5
  typeset -g POWERLEVEL9K_MY_PNPM_VERSION_ICON=''
